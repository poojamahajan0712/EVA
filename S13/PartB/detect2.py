...
if __name__ == '__main__':
    ...
    parser.add_argument('--names', type=str, default='data/testingcust/testingcust.names', help='*.names path')
    parser.add_argument('--weights', type=str, default='weights/last.pt', help='weights path')
    parser.add_argument('--source', type=str, default='/content/gdrive/My Drive/movieclip.mp4', help='source')  # input file/folder, 0 for webcam
